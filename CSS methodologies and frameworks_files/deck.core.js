...
(function($, undefined) {
  ...
  var bindMouseWheelEvents = function() {
    $container.unbind('mousewheel.deck');
    $container.bind('mousewheel.deck', function(event) {
      console.log(event.originalEvent.wheelDelta);
      
      event.originalEvent.wheelDelta < 0 ? methods.next() : methods.prev();
      event.preventDefault();
    })
  }
